...
public class Main {
	...
	private ArrayList<Customer> msCustomer = new ArrayList<>();
	private ArrayList<Room> msRoom = new ArrayList<>();
	private ArrayList<Transaction> msTransaction = new ArrayList<>();
	...
	private void checkInMenu() {
		...
		do {
			...
			cek = Room.checkNomorRuangan(nomorRuangan, msRoom);
		} while (cek != 1);
